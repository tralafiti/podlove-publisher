...
use Podlove\Modules\Newsletter\Model\Verification;
...
class Newsletter extends \Podlove\Modules\Base {
	...
	/**
	 * Singleton Newsletter Model
	 */

	/**
	 * Singleton instance container.
	 * @var \Podlove\Modules\Newsletter\Newsletter|NULL
	 */
	...
	static public function get_instance() {
		...
		// whenever the blog is switched, we need to reload all Newsletter data
	...
	/**
	 * Activation & Cronjob (clean_verifications)
	 */	
	...
	/**
	 * Subscription and verification of subscribers
	 */
	...
	public static function subscribe() {
		...
		if( isset( $_POST['podlove-newsletter-subscription-email'] ) ) {  // Without $_POST fields, there is no activity
			...
			$email_in_verification_process = Verification::find_one_by_property('email', $user_email);
